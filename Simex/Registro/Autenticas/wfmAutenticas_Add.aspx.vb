Imports prjDatos
Public Class wfmAutenticas_Add
    Inherits System.Web.UI.Page
    Private Funciones As New funciones
    Private sMensaje As String = ""
    Private Const spNombre As String = "pAutenticas_Add"
    Private sNombreMantenimiento = "Agregar Auténtica"
...
#Region "Metodos"
    ...
    Public Function dtParametros(Optional ByVal bInactivo As Boolean = False) As DataTable
        Try
            ...
            dtParametros.Rows.Add(dtcFechaAutentica.FieldName, dtcFechaAutentica.Value)
