<%@ Page Title="" Language="vb" AutoEventWireup="false" CodeBehind="wfmSeguimientoExpediente.aspx.vb" Inherits="smx.wfmSeguimientoExpediente" MasterPageFile="~/SubMenu.Master" %>
            ...
            <asp:Panel runat='server' Width="933px" ID="Panel1" Height="24px">
                <asp:GridView ID="GridView1" runat ="server" AutoGenerateColumns="False" 
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="FechaAsignacion" HeaderText="Fecha Asignación" AccessibleHeaderText="F. Asig." />
                        ...
                        <asp:BoundField DataField="IdTipoEstado" HeaderText="TipoEstado" Visible="False" />
                    </Columns>
                ...
                <table>
                    <tr>
                        ...
                        <td style="width: 371px; height: 20px;">
                            <telerik:RadDropDownTree ID="cboNuevoEstado" runat="server" AutoPostBack="True" CheckNodeOnClick="True" Culture="es-ES" DataFieldID="" DataFieldParentID="" DataTextField="" DataValueField="" EnableFiltering="True" ExpandNodeOnSingleClick="True" Height="16px" Width="362px" Skin="Office2007">
                                <DropDownSettings CloseDropDownOnSelection="True" Height="150px" Width="362px" />
                                <FilterSettings Highlight="Matches" EmptyMessage="No se encontraron registros..." MinFilterLength="2" />
                ...
                <asp:HyperLink ID="linkNuevo"  runat =server
                    NavigateUrl="~/Mantenimientos/Seguridad/usuario/wfmUsuario_Add.aspx" 
                    Visible="False">[linkNuevo]</asp:HyperLink>
                <asp:HyperLink ID="linkModificar" runat =server
                    NavigateUrl="~/Registro/Expediente/wfmExpedienteEstado_Edit.aspx" 
