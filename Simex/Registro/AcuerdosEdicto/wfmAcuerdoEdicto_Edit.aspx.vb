Imports prjDatos
Public Class wfmAcuerdoEdicto_Edit
    Inherits System.Web.UI.Page
    Private Funciones As New funciones
    Private dtDatos As New DataTable
    Private sMensaje As String = ""
    Private Const spNombre As String = "pAcuerdoEdicto_Edit"
    Private Const spListNombre As String = "pAcuerdoEdicto_List"
    Private sNombreMantenimiento = "Editar Acuerdo de Edicto"
#Region "Eventos"
...
#Region "Metodos"
    Private Sub CargarValores()
        Try
            If Session("ID") <> "" Then
                ...
                txtNumAcuerdoEdicto.Text = dtDatos.Rows(0).Item(txtNumAcuerdoEdicto.FieldName)
                dFechaAcuerdoEdicto.Value = dtDatos.Rows(0).Item(dFechaAcuerdoEdicto.FieldName)
            End If
    ...
    Public Function dtParametros(Optional ByVal bInactivo As Boolean = False) As DataTable
        Try
            ...
            dtParametros.Rows.Add(dFechaAcuerdoEdicto.FieldName, dFechaAcuerdoEdicto.Value)
