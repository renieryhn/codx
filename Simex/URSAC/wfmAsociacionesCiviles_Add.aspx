<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="wfmAsociacionesCiviles_Add.aspx.vb" Inherits="smx.wfmAsociacionesCiviles_Add" MasterPageFile="~/Propiedades.Master" %>
   ...
   <table style="width: 100%">
        ...
        <tr>
            <td style="width: 158px; height: 9px;">
                ...
                <uc4:SolicitanteResponsable ID="EncargadoResponsable" runat="server" MostrarApoderado="True" MostrarCliente="False" MostrarInstitucion="False" TipoEntidad="Apoderado" TipoEntidadCombo="1" />
            </td>
            <td style="height: 9px">
