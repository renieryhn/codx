Imports prjDatos
Public Class wfmAsociacionesCivilesMiembro_Edit
    Inherits System.Web.UI.Page
    Private Funciones As New funciones
    Private dtDatos As New DataTable
    Private sMensaje As String = ""
    Private Const spNombre As String = "pUR_RegistroJDDet_Edit"
    Private Const spListNombre As String = "pUR_RegistroJuntaDet_List"
    Private sNombreMantenimiento = "Editar Datos de Miembro de Junta Directiva"
#Region "Eventos"
    ...
    Private Sub CargarValores()
        Try
            If Session("CodigoRegistroJDDet") <> "" Then
                txtCodigo.Text = Session("CodigoRegistroJDDet")
                dtDatos = Funciones.Filldatatable(spListNombre, dtParametrosBusqueda)
                Miembro.idEntidad = dtDatos.Rows(0).Item("idPersona")
                cboPuesto.Value = dtDatos.Rows(0).Item("idPuesto")
            End If
