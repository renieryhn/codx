...
Public Class wfmRegistroInformesConst
    ...
    Protected Sub btnConsFin_Click(sender As Object, e As EventArgs) Handles btnConsFin.Click
        Try
            ' Fill the datasource from DB
            Dim nExp As String = Session("idRegistro")
            ...
            Dim ta2 As New Simex_DesDataSetTableAdapters.pUR_RegistroEstadoFinanciero_ListTableAdapter
            Dim dt2 As New Simex_DesDataSet.pUR_RegistroEstadoFinanciero_ListDataTable
            ...
            Me.rp.LocalReport.ReportPath = Server.MapPath("~/Reportes/") & "rptUR_ConstanciaFIN.rdlc"
            Me.rp.LocalReport.DataSources.Add(rptDataSource)
    ...
    Sub CargarConstanciaJD()
        Try
            ...
            Me.rp.LocalReport.ReportPath = Server.MapPath("~/Reportes/") & "rptUR_ConstanciaJD.rdlc"
            Me.rp.LocalReport.DataSources.Add(rptDataSource)
            Me.rp.LocalReport.DataSources.Add(rptDataSource2)
    ...
    Protected Sub btnConsReg_Click(sender As Object, e As EventArgs) Handles btnConsReg.Click
        Try
            ...
            Dim ta2 As New Simex_DesDataSetTableAdapters.pUR_Resolucion_ListTableAdapter
            Dim dt2 As New Simex_DesDataSet.pUR_Resolucion_ListDataTable
            ta2.Fill(dt2, Nothing, nExp, Nothing)

            Dim i As Integer

            Dim sResoluciones As String = dt2.Rows(0).Item("NumResolucion").ToString
            If dt2.Rows.Count > 1 Then
                sResoluciones += " y con "
                For i = 1 To dt2.Rows.Count - 1
                    sResoluciones += dt2.Rows(i).Item("Justificacion").ToString + " " + dt2.Rows(i).Item("NumResolucion").ToString + " de fecha " + CDate(dt2.Rows(i).Item("Fecha")).ToShortDateString
            ...
            parametros(0) = New ReportParameter("Resoluciones", sResoluciones)

            Me.rp.LocalReport.ReportPath = Server.MapPath("~/Reportes/") & "rptUR_ConstanciaREG.rdlc"
            Me.rp.LocalReport.DataSources.Add(rptDataSource)
            Me.rp.LocalReport.DataSources.Add(rptDataSource2)
