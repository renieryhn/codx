<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="URSubMenu.Master" EnableEventValidation="false" CodeBehind="wfmLibroRegistroJuntaDirectiva.aspx.vb" Inherits="smx.wfmLibroRegistroJuntaDirectiva" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
   ...
   <div id="Forma" style="width: 166%; height: 235%; border: thin none #E0E0E0; position: relative; top: 15px; left: -5px;" >
    ...
    &nbsp;<asp:Button ID="btnImprimir" runat="server" Text="Imprimir Histórico" CssClass="Boton" Height="45px" Width="244px" />
            


    &nbsp;<asp:Button ID="btnImprimir0" runat="server" Text="Imprimir Constancia" CssClass="Boton" Height="45px" Width="244px" />
