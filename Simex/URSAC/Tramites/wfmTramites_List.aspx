<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="wfmTramites_List.aspx.vb" Inherits="smx.wfmTramites_List" MasterPageFile="~/Consulta.Master" %>
...
<div id="filtros" class="DD">
    <div style="background-position: left top; border: 1px solid #F5F5F5; width: 120px; position: absolute; top: 150px; left: 5px; height: 82%; background-color: #999999; background-image: url('../../Imagenes/Tramites.jpg'); background-repeat: no-repeat; background-attachment: scroll;">

    </div>
    <div style="background-position: left top; position: absolute; top: 152px; left: 130px; width: 90%; height: 82%; background-image: url('../../Imagenes/Tramites2.jpg'); background-repeat: repeat-x; background-attachment: scroll; background-color: #BFBFBF;">
    ...
    <div id ="Gridview">
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="FechaCreacion" DataFormatString="{0:d}" HeaderText="Fecha Trámite" />
            ...
            <asp:HyperLink ID="linkModificar" runat="server" 
                NavigateUrl="~/Otros/Tramites/wfmTramites_Edit.aspx" 
                Visible="False">[linkModificar]</asp:HyperLink>
        <asp:HyperLink ID="linkSeguimiento" runat="server" NavigateUrl="~/Otros/Tramites/wfmTramitesJuntaDirectiva.aspx"
