<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="URSubMenu.Master" EnableEventValidation="false" CodeBehind="wfmRegistroInformesConst.aspx.vb" Inherits="smx.wfmRegistroInformesConst" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
   ...
   <div id="Forma" style="width: 166%; height: 235%; border: thin none #E0E0E0; position: relative; top: 15px; left: -5px;" >
       ...
       <table style="width: 100%">
        ...
        <asp:Button ID="btnCaratural" runat="server" Text="Carátula para el Folder" CssClass="Boton" Height="45px" Width="243px" />
            
               </td>
               <td style="text-align: left; width: 215px;">

                   <asp:Button ID="btnConsFin" runat="server" CssClass="Boton" Height="45px" Text="Constancia Financiera" Width="230px" />
