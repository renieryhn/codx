<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="wfmAsociacionesCivilesEstado_Edit.aspx.vb" Inherits="smx.wfmAsociacionesCivilesEstado_Edit" MasterPageFile="URSubMenu.Master" %>
                    ...
                    <tr>
                        ...
                        <td colspan="2">
                            <asp:HyperLink ID="linkMain" runat="server" 
                                NavigateUrl="~/URSAC/wfmSeguimientoRegistro.aspx" 
