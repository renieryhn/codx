<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="wfmLibroRegistroMiembro_Add.aspx.vb" Inherits="smx.wfmLibroRegistroMiembro_Add" MasterPageFile="~/Propiedades.Master" %>
...
<table class="DD">
            <tr>
                ...
                <uc4:SolicitanteResponsable ID="Miembro" runat="server" MostrarApoderado="False" MostrarCliente="True" MostrarInstitucion="False" TipoEntidad="Miembro" TipoEntidadCombo="1" />
                    <br />
                    <label for="dtcfTomaPosesion" __designer:mapid="58d">Puesto: <uc2:ComboBox ID="cboPuesto" runat="server" AutoFill="True" FieldName="IdPuesto" idFieldName="id" Obligatorio="True" TableName="UR_PuestoJuntaDirectiva" textFieldName="Nombre" />
                         </label>
                    </td>
                <td>
