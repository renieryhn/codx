<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="wfmResolucionesEsp_Add.aspx.vb" Inherits="smx.wfmResolucionesEsp_Add" MasterPageFile="~/Propiedades.Master" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphContenido" runat="server">
    ...
    <uc2:DateControl ID="dtcFecha" runat="server" FechaHora="False" FieldName="Fecha" SoloLectura="False" Obligatorio="True" />
            ...
            <tr>
                <td>&nbsp;</td>
                <td style="width: 144px">Número de Resolución:</td>
                <td style="width: 199px">
