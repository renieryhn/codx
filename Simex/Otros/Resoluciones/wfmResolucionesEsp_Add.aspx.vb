Imports prjDatos
Public Class wfmResolucionesEsp_Add
    ...
    Private nombre = "Agregar Resolución Especial"

    Private Const spNombre As String = "pResolucionesEsp_Add"
    Private Const spNombreSPMax As String = "pResolucionesMax"
...
#Region "Metodos"
    ...
    Public Function dtParametros(Optional ByVal bInactivo As Boolean = False) As DataTable
        Try
            ...
            dtParametros.Rows.Add(txtNumeroResolucion.FieldName, txtNumeroResolucion.Text)
...
#End Region
    ...
    Protected Sub btnGet_Click(sender As Object, e As EventArgs) Handles btnGet.Click
        ...
        txtNumeroResolucion.Text = tbl.Rows(0).Item(0).ToString
    End Sub
