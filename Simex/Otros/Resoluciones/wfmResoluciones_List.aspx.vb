Imports prjDatos
Public Class wfmResoluciones_List
    ...
    Private sNombreBorrado As String = "pResoluciones_Delete"
    Private nombre = "Resoluciones"
#Region "Eventos"
    ...
    Protected Sub btnExportar_Click(ByVal sender As Object, ByVal e As EventArgs)
        ...
        llenarGrid()
        Master.Exportar(GridView1, dtParametrosExportar, "Mantenimiento de Firmas")
    End Sub
...
#Region "Metodos"
    ...
    Private Function dtParametrosExportar() As DataTable
        Try
            ...
            dtParametrosExportar.Rows.Add("Nombre", txtResolucion.Text)
    ...
    Private Function dtParametros() As DataTable
        Try
            ...
            dtParametros.Rows.Add(txtResolucion.FieldName, txtResolucion.Text)
        Catch ex As Exception
            Throw (ex)
        End Try
    End Function
