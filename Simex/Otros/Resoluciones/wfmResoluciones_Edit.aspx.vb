Imports prjDatos
Public Class wfmResoluciones_Edit
    Inherits System.Web.UI.Page
    Private Funciones As New funciones
    Private dtDatos As New DataTable
    Private sMensaje As String = ""
    Private Const spNombre As String = "pResoluciones_Edit"
    Private Const spListNombre As String = "pResoluciones_List"
    Private nombre = "Editar Resolucion"
#Region "Eventos"
    ...
    Private Sub CargarValores()
        Try
            If Session("ID") <> "" Then
                ...
                txtNumeroResolucion.Text = dtDatos.Rows(0).Item(txtNumeroResolucion.FieldName)
                txtExpediente.Text = dtDatos.Rows(0).Item(txtExpediente.FieldName).ToString
                txtJustificacion.Text = dtDatos.Rows(0).Item(txtJustificacion.FieldName).ToString
                dtcFecha.Value = dtDatos.Rows(0).Item(dtcFecha.FieldName)
            End If
