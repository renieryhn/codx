Imports prjDatos
Public Class wfmApoderados_Edit
    Inherits System.Web.UI.Page
    Private Funciones As New funciones
    Private dtDatos As New DataTable
    Private sMensaje As String = ""
    Private Const spNombre As String = "pApoderados_Edit"
    Private Const spListNombre As String = "pApoderados_List"
    Private pageTitle = "Editar Apoderado"
#Region "Eventos"
    ...
    Private Sub CargarValores()
        Try
            If Session("ID") <> "" Then
                ...
                txtEmail2.Text = dtDatos.Rows(0).Item(txtEmail2.FieldName).ToString
