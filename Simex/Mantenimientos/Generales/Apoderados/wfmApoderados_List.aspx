<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="wfmApoderados_List.aspx.vb" Inherits="smx.wfmApoderados_List" MasterPageFile="~/Consulta.Master" %>
...
<asp:Content ID="Content1" runat="server" 
    ...
    <div class="DD">
    <table class="style1" style="width: 90%">
            <tr>
                <td class="style4" style="width: 118px" align="left">
            ...
            <tr>
                <td class="style4" style="width: 118px; height: 24px;" align="left">
                    No. Identidad</td>
                <td class="style5" style="width: 868px; height: 24px;" align="left">
            ...
            <tr>
                <td class="style4" style="width: 118px; height: 24px;" align="left">
                    No. Colegiación</td>
                <td class="style5" style="width: 868px; height: 24px;" align="left">
                    <uc1:TextBox ID="txtColegiacion" runat="server" FieldName="Id" 
                        width="100" MaxLength="15" ValorMaximo="6" />
                </td>
            </tr>
            <tr>
                <td class="style4" style="width: 118px" align="left">
            ...
            <tr>
                <td class="style4" style="width: 118px; height: 30px;" align="left">
            ...
            <tr>                
                <td class="style2" colspan="2">
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                        ...
                        AllowSorting="True" DataKeyNames="Id" PageSize="15" CssClass="mGrid" 
                        EmptyDataText="No se encontraron registros" BorderStyle="None" BorderWidth="1px" CellSpacing="2" AlternatingRowStyle-CssClass="alt" Width="1054px">
<AlternatingRowStyle CssClass="alt"></AlternatingRowStyle>
                    ...
                    <asp:HyperLink ID="linkModificar" runat="server" 
                        NavigateUrl="~/Mantenimientos/Generales/Apoderados/wfmApoderados_Edit.aspx" 
