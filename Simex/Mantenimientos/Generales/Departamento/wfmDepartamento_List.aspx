<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="wfmDepartamento_List.aspx.vb" Inherits="smx.wfmDepartamento_List" MasterPageFile="~/Consulta.Master" %>
...
<asp:Content ID="Content1" runat="server" 
   ...
   <p>
                    ...
                    <asp:HyperLink ID="linkModificar" runat="server" 
                        NavigateUrl="~/Mantenimientos/Generales/Departamento/wfmDepartamento_Edit.aspx" 
