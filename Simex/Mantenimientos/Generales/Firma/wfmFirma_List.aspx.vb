...
Public Class wfmFirma_List
    ...
    Dim Ok As Boolean
    Private sNombreBusqueda As String = "pFirma_List"
    Private sNombreBorrado As String = "pFirma_Delete"
    Private sNombreMantenimiento = "Mantenimiento de Firmas"
