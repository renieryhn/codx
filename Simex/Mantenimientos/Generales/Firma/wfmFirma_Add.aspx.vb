...
Public Class wfmFirma_Add
    ...
    Private Const spNombre As String = "pFirma_Add"
    Private sNombreMantenimiento = "Agregar Firma"
...
#Region "Eventos"
    ...
    Protected Sub btnAplicar_Click(ByVal sender As Object, ByVal e As EventArgs)
        ...
        End If
    End Sub
    Private Sub cboEmpleados_ComboChangedItem(ByVal sender As Object, ByVal e As System.EventArgs) Handles cboEmpleados.ComboChangedItem
        Dim strQuery As String = ""
        If strQuery = "" Then
            strQuery = "SELECT  Empleados.ID, Empleados.NumIdentidad, Puesto.Nombre FROM Empleados INNER JOIN Puesto ON Empleados.ID = Puesto.id"
        End If
    End Sub
