<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="wfmInstituciones_List.aspx.vb" Inherits="smx.wfmInstituciones_List" MasterPageFile="~/Consulta.Master" %>
            ...
            <tr>                
                <td class="style2" colspan="2">
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                        ...
                        EmptyDataText="No se encontraron registros" CssClass="mGrid" BorderStyle="None" BorderWidth="1px" CellSpacing="2" PageSize="9" >
