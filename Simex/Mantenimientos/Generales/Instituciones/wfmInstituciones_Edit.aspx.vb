...
Public Class wfmInstituciones_Edit
    ...
    Private sNombreMantenimiento = "Editar Institución"
#Region "Eventos"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            Dim sValue As String = Request.QueryString("ID")
            CargarValores(sValue)
        End If
    End Sub
...
#End Region
#Region "Metodos"
    Private Sub CargarValores(sValue As String)
        Try
            If sValue <> "" Then
                Session("ID") = sValue
            End If
