<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="wfmInstituciones_Add.aspx.vb" Inherits="smx.wfmInstituciones_Add" MasterPageFile="~/Propiedades.Master" %>
...
<asp:Content ID="Content1" runat="server" contentplaceholderid="cphContenido">
    <table class="DD" style="width: 600px">
            <tr>
                <td class="style2" align="left" style="width: 116px">
            ...
            <tr>
                <td class="style2" align="left" style="width: 116px">
                    Email</td>
                <td style="width: 232px">
                    <uc1:TextBox ID="txtEmailContacto" runat="server" FieldName="EmailContacto" />
                </td>
            </tr>
            <tr>
                <td class="style2" align="left" style="width: 116px">
