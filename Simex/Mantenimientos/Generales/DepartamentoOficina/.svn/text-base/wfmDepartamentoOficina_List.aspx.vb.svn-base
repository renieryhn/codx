Imports prjDatos
Public Class wfmDepartamentoOficina_List
    Inherits System.Web.UI.Page
    Dim cFunciones As New funciones
    Private sMensaje As String = ""
    Private Codigo As String = ""
    Dim Ok As Boolean
    Private sNombreBusqueda As String = "pDeptoOficina_List"
    Private sNombreBorrado As String = "pDeptoOficina_Delete"
    Private pageTitle = "Oficinas"
...
#Region "Eventos"
    ...
    Protected Sub btnExportar_Click(ByVal sender As Object, ByVal e As EventArgs)
        Master.Exportar(GridView1, dtParametrosExportar, "Mantenimiento de Departamentos Oficinas")
    End Sub
