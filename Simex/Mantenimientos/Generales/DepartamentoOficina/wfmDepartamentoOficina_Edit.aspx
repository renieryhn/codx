<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="wfmDepartamentoOficina_Edit.aspx.vb" Inherits="smx.wfmDepartamentoOficina_Edit" MasterPageFile="../../../Propiedades.Master" %>
            ...
            <tr>
                <td class="style2" align="left">
                    <asp:HyperLink ID="linkMain" runat="server" 
                        NavigateUrl="~/Mantenimientos/Generales/DepartamentoOficina/wfmDepartamentoOficina_List.aspx" 
