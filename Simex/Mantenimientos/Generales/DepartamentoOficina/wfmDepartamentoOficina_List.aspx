<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="wfmDepartamentoOficina_List.aspx.vb" Inherits="smx.wfmDepartamentoOficina_List" MasterPageFile="~/Consulta.Master" %>
...
<asp:Content ID="Content1" runat="server" 
	...
	<table class="DD" style="width: 644px">
            <tr>
            ...
            <tr>
                ...
                <td class="style2" colspan="2">
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                        ...
                        EmptyDataText="No se encontraron registros" CssClass="mGrid" BorderStyle="None" BorderWidth="1px" CellSpacing="2" Width="622px" >
                    ...
                    <asp:HyperLink ID="linkNuevo" runat="server" 
                        NavigateUrl="~/Mantenimientos/Generales/DepartamentoOficina/wfmDepartamentoOficina_Add.aspx" 
                        Visible="False">[linkNuevo]</asp:HyperLink>
                    <asp:HyperLink ID="linkModificar" runat="server" 
                        NavigateUrl="~/Mantenimientos/Generales/DepartamentoOficina/wfmDepartamentoOficina_Edit.aspx" 
