Imports prjDatos
Public Class wfmDiasFestivos_Edit
    Inherits System.Web.UI.Page
    Private Funciones As New funciones
    Private dtDatos As New DataTable
    Private sMensaje As String = ""
    Private Const spNombre As String = "pDiasFestivos_Edit"
    Private Const spListNombre As String = "pDiasFestivos_List"
    Private pageTitle = "Editar DiasFestivos"
#Region "Eventos"
...
#Region "Metodos"
    Private Sub CargarValores()
        Try
            If Session("ID") <> "" Then
                ...
                txtDia.Text = dtDatos.Rows(0).Item("Dia")
                txtMes.Text = dtDatos.Rows(0).Item("Mes")
                txtAño.Text = dtDatos.Rows(0).Item("Año")
            End If
    ...
    Public Function dtParametros(Optional ByVal bInactivo As Boolean = False) As DataTable
        Try
            ...
            dtParametros.Rows.Add("Dia", txtDia.Text)
            dtParametros.Rows.Add("Mes", txtMes.Text)
            dtParametros.Rows.Add("AÑo", txtAño.Text)
