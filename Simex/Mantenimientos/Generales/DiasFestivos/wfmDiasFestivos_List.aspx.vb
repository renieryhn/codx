Imports prjDatos
Public Class wfmDiasFestivos_List
    Inherits System.Web.UI.Page
    Dim cFunciones As New funciones
    Private sMensaje As String = ""
    Private Codigo As String = ""
    Dim Ok As Boolean
    Private sNombreBusqueda As String = "pDiasFestivos_List"
    Private sNombreBorrado As String = "pDiasFestivos_Delete"
    Private pageTitle = "DiasFestivoss"
...
#Region "Eventos"
    ...
    Protected Sub btnExportar_Click(ByVal sender As Object, ByVal e As EventArgs)
        Master.Exportar(GridView1, dtParametrosExportar, "Mantenimiento de DiasFestivoss")
    End Sub
