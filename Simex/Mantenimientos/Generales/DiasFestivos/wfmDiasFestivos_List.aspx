<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="wfmDiasFestivos_List.aspx.vb" Inherits="smx.wfmDiasFestivos_List" MasterPageFile="~/Consulta.Master" %>
...
<asp:Content ID="Content1" runat="server" 
   ...
   <p>
                    ...
                    <asp:HyperLink ID="linkModificar" runat="server" 
                        NavigateUrl="~/Mantenimientos/Generales/DiasFestivos/wfmDiasFestivos_Edit.aspx" 
