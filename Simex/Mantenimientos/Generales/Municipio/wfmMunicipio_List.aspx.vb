Imports prjDatos
Public Class wfmMunicipio_List
    Inherits System.Web.UI.Page
    Dim cFunciones As New funciones
    Private sMensaje As String = ""
    Private Codigo As String = ""
    Dim Ok As Boolean
    Private sNombreBusqueda As String = "pMunicipio_List"
    Private sNombreBorrado As String = "pMunicipio_Delete"
    Private sNombreMantenimiento = "Mantenimiento de Municipios"
#Region "Eventos"
...
#Region "Metodos"
    ...
    Private Function dtParametrosExportar() As DataTable
        Try
            ...
            dtParametrosExportar.Rows.Add("Departamento", cboDepartamento.Text)
