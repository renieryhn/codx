Imports prjDatos
Public Class wfmMunicipio_Edit
    Inherits System.Web.UI.Page
    Private Funciones As New funciones
    Private dtDatos As New DataTable
    Private sMensaje As String = ""
    Private Const spNombre As String = "pMunicipio_Edit"
    Private Const spListNombre As String = "pMunicipio_List"
    Private sNombreMantenimiento = "Editar Municipio"
#Region "Eventos"
    ...
    Private Sub CargarValores()
        Try
            If Session("ID") <> "" Then
                ...
                cboDepartamento.Value = dtDatos.Rows(0).Item(cboDepartamento.FieldName)
