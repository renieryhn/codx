<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="wfmRequisitos_Edit.aspx.vb" Inherits="smx.wfmRequisitos_Edit" MasterPageFile="~/Propiedades.Master" %>
            ...
            <tr>
                ...
                <td>
                    <uc1:TextBox ID="txtNombre" runat="server" Habilitado="True" 
                        ...
                        MaxLength="4000" width="400" Apariencia="Multiline" Height="100" />
                </td>
            </tr>
            <tr>
                <td class="style2" align="left">
            ...
            <tr>
                <td class="style2" align="left">
                    <asp:HyperLink ID="linkMain" runat="server" 
                        NavigateUrl="~/Mantenimientos/Generales/Requisitos/wfmRequisitos_List.aspx" 
