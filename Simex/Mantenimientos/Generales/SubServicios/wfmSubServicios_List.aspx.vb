Imports prjDatos
Public Class wfmSubServicios_List
    Inherits System.Web.UI.Page
    Dim cFunciones As New funciones
    Private sMensaje As String = ""
    Private Codigo As String = ""
    Dim Ok As Boolean
    Private sNombreBusqueda As String = "pSubServicios_List"
    Private sNombreBorrado As String = "pSubServicios_Delete"
    Private sNombreMantenimiento = "Mantenimiento de Sub Servicios"
#Region "Eventos"
...
#Region "Metodos"
    ...
    Private Function dtParametros(ByVal id As String) As DataTable
        Try
            dtParametros = cFunciones.dtDatos.Clone
            dtParametros.Rows.Add("Codigo", id)
        Catch ex As Exception
            Throw (ex)
        End Try
    End Function
