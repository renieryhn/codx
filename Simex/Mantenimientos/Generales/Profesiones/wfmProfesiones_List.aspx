<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="wfmProfesiones_List.aspx.vb" Inherits="smx.wfmProfesiones_List" MasterPageFile="~/Consulta.Master" %>
...
<asp:Content ID="Content1" runat="server" 
    ...
    <div class="DD">
	<table class="style1" style="width: 667px">
            <tr>
            ...
            <tr>
                ...
                <td class="style2" colspan="2">
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                        ...
                        EmptyDataText="No se encontraron registros" CssClass="mGrid" BorderStyle="None" BorderWidth="1px" CellSpacing="2" Width="641px" >
                    ...
                    <asp:HyperLink ID="linkNuevo" runat="server" 
                        NavigateUrl="~/Mantenimientos/Generales/Profesiones/wfmProfesiones_Add.aspx" 
                        Visible="False">[linkNuevo]</asp:HyperLink>
                    <asp:HyperLink ID="linkModificar" runat="server" 
                        NavigateUrl="~/Mantenimientos/Generales/Profesiones/wfmProfesiones_Edit.aspx" 
