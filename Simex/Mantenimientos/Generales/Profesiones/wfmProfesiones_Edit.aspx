<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="wfmProfesiones_Edit.aspx.vb" Inherits="smx.wfmProfesiones_Edit" MasterPageFile="~/Propiedades.Master" %>
            ...
            <tr>
                <td class="style2" align="left">
                    <asp:HyperLink ID="linkMain" runat="server" 
                        NavigateUrl="~/Mantenimientos/Generales/Profesiones/wfmProfesiones_List.aspx" 
