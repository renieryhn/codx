<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="wfmPuesto_List.aspx.vb" Inherits="smx.wfmPuesto" MasterPageFile="~/Consulta.Master" %>
...
<asp:Content ID="Content1" runat="server" 
    ...
    <div class="DD">
	<table class="style1" style="width: 653px">
            <tr>
                <td class="style4" style="width: 91px">
                    <asp:Label ID="Label2" runat="server" Text="Nombre"></asp:Label>
                </td>
                <td align="left" class="style5" style="width: 869px">
            ...
            <tr>
                ...
                <td class="style5" style="width: 869px">
                    </td>
            </tr>
            <tr>
                ...
                <td class="style2" colspan="2">
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                        ...
                        EmptyDataText="No se encontraron registros" CssClass="mGrid" BorderStyle="None" BorderWidth="1px" CellSpacing="2" Width="633px" >
                    ...
                    <asp:HyperLink ID="linkModificar" runat="server" 
                        NavigateUrl="~/Mantenimientos/Generales/Puesto/wfmPuesto_Edit.aspx" 
