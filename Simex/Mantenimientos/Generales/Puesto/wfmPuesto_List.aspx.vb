Imports prjDatos
Public Class wfmPuesto
    Inherits System.Web.UI.Page
    Dim cFunciones As New funciones
    Private sMensaje As String = ""
    Private Codigo As String = ""
    Dim Ok As Boolean
    Private sNombreBusqueda As String = "pPuesto_List"
    Private sNombreBorrado As String = "pPuesto_Delete"
    Private sNombreMantenimiento = "Mantenimiento de Puestos"
...
#Region "Eventos"
    ...
    Protected Sub btnExportar_Click(ByVal sender As Object, ByVal e As EventArgs)
        Master.Exportar(GridView1, dtParametrosExportar, "Mantenimiento de Puestos")
    End Sub
