Imports prjDatos
Public Class wfmQuejas_List
    Inherits System.Web.UI.Page
    Dim cFunciones As New funciones
    Private sMensaje As String = ""
    Private Codigo As String = ""
    Dim Ok As Boolean
    Private sNombreBusqueda As String = "pQuejas_List"
    Private sNombreBorrado As String = "pQuejas_Delete"
    Private sNombreMantenimiento = "Mantenimiento de Quejas"
#Region "Eventos"
