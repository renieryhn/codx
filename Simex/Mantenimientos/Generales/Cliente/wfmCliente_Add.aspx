<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Propiedades.Master" CodeBehind="wfmCliente_Add.aspx.vb" Inherits="smx.wfmCliente_Add" %>
...
<asp:Label ID="Label10" runat="server" Text="Fax"></asp:Label>
            ...
            <td>
<uc1:TextBox ID="txtNumFax" runat="server" Habilitado="True" Obligatorio="False" FieldName="NumFax" Int="False" Align="Izquierda" 
MaxLength="10" width="100" />
            </td>
        </tr>
        <tr>
...
<asp:Label ID="Label3" runat="server" Text="Primer Nombre"></asp:Label>                
            ...
            <td>                
<uc1:TextBox ID="txtNombre1" runat="server" Habilitado="True" Obligatorio="True" FieldName="Nombre1" Int="False" Align="Izquierda" 
MaxLength="15" width="150" />
            </td>
            <td>
<asp:Label ID="Label11" runat="server" Text="Teléfono Móvil 1"></asp:Label>
            ...
            <td>
<uc1:TextBox ID="txtTelefonoMovil1" runat="server" Habilitado="True" Obligatorio="False" FieldName="TelMovil1" Int="False" Align="Izquierda" 
MaxLength="10" width="100" />
            </td>
        </tr>
        <tr>
...
<asp:Label ID="Label4" runat="server" Text="Segundo Nombre"></asp:Label>
            ...
            <td>
<uc1:TextBox ID="txtNombre2" runat="server" Habilitado="True" Obligatorio="False" FieldName="Nombre2" Int="False" Align="Izquierda" 
MaxLength="15" width="150" />
            </td>
            <td>                
<asp:Label ID="Label12" runat="server" Text="Teléfono Móvil 2"></asp:Label>
            ...
            <td>
<uc1:TextBox ID="txtTelefonoMovil2" runat="server" Habilitado="True" Obligatorio="False" FieldName="TelMovil2" Int="False" Align="Izquierda" 
MaxLength="10" width="100" />
            </td>
        </tr>
        <tr>
...
<asp:Label ID="Label5" runat="server" Text="Primer Apellido"></asp:Label>
            ...
            <td>
<uc1:TextBox ID="txtApellido1" runat="server" Habilitado="True" Obligatorio="True" FieldName="Apellido1" Int="False" Align="Izquierda" 
MaxLength="15" width="150" />
            </td>
            <td>
...
<asp:Label ID="Label6" runat="server" Text="Segundo Apellido"></asp:Label>
            ...
            <td>
<uc1:TextBox ID="txtApellido2" runat="server" Habilitado="True" Obligatorio="False" FieldName="Apellido2" Int="False" Align="Izquierda" 
MaxLength="15" width="150" />
            </td>
            <td>
...
<asp:Label ID="Label18" runat="server" Text="Municipio"></asp:Label>
            ...
            <td>
<uc2:ComboBox ID="cboMunicipio" runat="server" AutoFill="False" FieldName="idMunicipio" idFieldName="id" idParentComboBox="idDepartamento" 
...
MaxLength="400" width="300" EnableViewState="True" Height="100" Apariencia="Multiline" />
            </td>
            <td>                
...
MaxLength="1000" width="300" EnableViewState="True" Height="100" Apariencia="Multiline"/>
            </td>
            <td>                
