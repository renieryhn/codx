...
Partial Public Class wfmCliente_List
    ...
    '''Para modificarlo, mueva la declaración del campo del archivo del diseñador al archivo de código subyacente.
    '''</remarks>
    Protected WithEvents txtIdentidad As Global.smx.WebUserControl1
    ...
    '''</remarks>
    Public Shadows ReadOnly Property Master() As Global.smx.Consulta
        Get
            Return CType(MyBase.Master, Global.smx.Consulta)
        End Get
    End Property
End Class
