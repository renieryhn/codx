<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="wfmEstado_Add.aspx.vb" Inherits="smx.wfmEstado_Add" MasterPageFile="~/Propiedades.Master" %>
...
<asp:Content ID="Content1" runat="server" contentplaceholderid="cphContenido">
    <table class="DD">
            <tr>
                <td class="style2" align="left" style="width: 140px">
            ...
            <tr>
                <td class="style2" align="left" style="height: 27px; width: 140px;">
            ...
            <tr>
                <td class="style2" align="left" style="height: 29px; width: 140px;">
            ...
            <tr>
                <td class="style2" align="left" style="height: 78px; width: 140px;">
            ...
            <tr>
                <td class="style2" align="left" style="width: 140px; height: 32px">
                    <asp:Label ID="Label6" runat="server" Text="Estado"></asp:Label>
                </td>
                <td style="height: 32px">
                    <asp:RadioButtonList ID="rbEstado" runat="server" Width="192px">
            ...
            <tr>
                <td class="style2" align="left" style="width: 140px; height: 6px">
