Imports prjDatos
Public Class wfmEstado_List
    Inherits System.Web.UI.Page
    Dim cFunciones As New funciones
    Private sMensaje As String = ""
    Private Codigo As String = ""
    Dim Ok As Boolean
    Private sNombreBusqueda As String = "pEstado_List"
    Private sNombreBorrado As String = "pEstado_Delete"
    Private sNombreMantenimiento = "Mantenimiento de estados"
#Region "Eventos"
    ...
    Protected Sub btnExportar_Click(ByVal sender As Object, ByVal e As EventArgs)
        Master.Exportar(GridView1, dtParametrosExportar, "Mantenimiento de Estados")
    End Sub
