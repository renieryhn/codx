<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="wfmPaises_List.aspx.vb" Inherits="smx.wfmPaises" MasterPageFile="~/Consulta.Master" %>
...
<asp:Content ID="Content1" runat="server" 
    ...
    <div class="DD">
	  <table class="style1" style="width: 697px">
            <tr>
                <td class="style4" style="width: 91px; height: 23px;">
                    <asp:Label ID="Label2" runat="server" Text="Nombre"></asp:Label>
                </td>
                <td align="left" class="style5" style="width: 868px; height: 23px;">
            ...
            <tr>
                ...
                <td class="style2" colspan="2">
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                        ...
                        EmptyDataText="No se encontraron registros" CssClass="mGrid" BorderStyle="None" BorderWidth="1px" CellSpacing="2" Width="655px" >
                    ...
                    <asp:HyperLink ID="linkModificar" runat="server" 
                        NavigateUrl="~/Mantenimientos/Generales/Paises/wfmPaises_Edit.aspx" 
