Imports prjDatos
Public Class wfmPaises
    Inherits System.Web.UI.Page
    Dim cFunciones As New funciones
    Private sMensaje As String = ""
    Private Codigo As String = ""
    Dim Ok As Boolean
    Private sNombreBusqueda As String = "pPaises_List"
    Private sNombreBorrado As String = "pPaises_Delete"
    Private sNombreMantenimiento = "Mantenimiento de Paises"
#Region "Eventos"
    ...
    Private Sub wfmUsuario_List_PreRender(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreRender
        GridView1.Columns(0).Visible = Master.Master.Modificacion
        GridView1.Columns(1).Visible = Master.Master.Borrado
        If Not IsPostBack Then
            llenarGrid()
