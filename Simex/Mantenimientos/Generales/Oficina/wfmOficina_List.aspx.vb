Imports prjDatos
Public Class wfmOficina_List
    Inherits System.Web.UI.Page
    Dim cFunciones As New funciones
    Private sMensaje As String = ""
    Private Codigo As String = ""
    Dim Ok As Boolean
    Private sNombreBusqueda As String = "pOficina_List"
    Private sNombreBorrado As String = "pOficina_Delete"
    Private sNombreMantenimiento = "Mantenimiento de Oficinas"
#Region "Eventos"
    ...
    Protected Sub btnExportar_Click(ByVal sender As Object, ByVal e As EventArgs)
        Master.Exportar(GridView1, dtParametrosExportar, "Mantenimiento de Oficinas")
    End Sub
...
#Region "Metodos"
    ...
    Private Function dtParametros() As DataTable
        Try
            ...
            dtParametros.Rows.Add(cboActivo.FieldName, cboActivo.Value)
        Catch ex As Exception
            Throw (ex)
        End Try
    End Function
