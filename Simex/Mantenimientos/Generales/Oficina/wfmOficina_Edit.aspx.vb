...
Public Class wfmOficina_Edit
    ...
    Dim Ok As Boolean
    Private Const spNombre As String = "pOficina_Edit"
    Private Const spListNombre As String = "pOficina_List"
    Private sNombreMantenimiento = "Editar Oficina"
#Region "Eventos"
...
#Region "Metodos"
    Private Sub CargarValores()
        Try
            If Session("ID") <> "" Then
                ...
                chkActivo.Checked = dtDatos.Rows(0).Item("indEstado")
            End If
    ...
    Public Function dtParametros(Optional ByVal bInactivo As Boolean = False) As DataTable
        Try
            ...
            dtParametros.Rows.Add("indEstado", chkActivo.Checked)
