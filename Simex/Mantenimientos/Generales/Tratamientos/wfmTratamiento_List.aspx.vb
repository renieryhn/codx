Imports prjDatos
Public Class wfmTratamiento_List
    ...
    Dim Ok As Boolean
    Private sNombreBusqueda As String = "pTratamiento_List"
    Private sNombreBorrado As String = "pTratamiento_Delete"
    Private sNombreMantenimiento = "Mantenimiento de Tratamientos"
...
#Region "Eventos"
    ...
    Protected Sub btnExportar_Click(ByVal sender As Object, ByVal e As EventArgs)
        Master.Exportar(GridView1, dtParametrosExportar, "Mantenimiento de Tratamientos")
    End Sub
