...
Public Class wfmRequisitosSubServicios_Edit
    ...
    Private sNombreMantenimiento = "Editar Requisitos Sub Servicio"
...
#Region "Metodos"
    ...
    Public Function dtParametrosBusqueda(Optional ByVal bInactivo As Boolean = False) As DataTable
        Try
            ...
            dtParametrosBusqueda.Rows.Add("idRequisito", txtidRequisito.Text)
        Catch ex As Exception
            Throw (ex)
        End Try
    End Function
