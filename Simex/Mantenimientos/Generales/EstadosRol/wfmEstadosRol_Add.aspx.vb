Imports prjDatos
Public Class wfmEstadosRol_Add
    ...
    Private Const spNombre As String = "pEstadosRol_Add"
    Private sNombreMantenimiento = "Agregar Estados a rol"
...
#Region "Eventos"
    ...
    Protected Sub btnAplicar_Click(ByVal sender As Object, ByVal e As EventArgs)
        ...
        End If
    End Sub
    Private Sub cboRoles_ComboChangedItem(ByVal sender As Object, ByVal e As System.EventArgs) Handles cboRoles.ComboChangedItem
