...
Public Class wfmEstadosRoles
    ...
    Dim Ok As Boolean
    Private sNombreBusqueda As String = "pEstadosRol_List"
    Private sNombreBorrado As String = "pEstadosRol_Delete"
    Private sNombreMantenimiento = "Mantenimiento de Estados/Rol"
#Region "Eventos"
    ...
    Protected Sub btnExportar_Click(ByVal sender As Object, ByVal e As EventArgs)
        Master.Exportar(GridView1, dtParametrosExportar, "Mantenimiento de Municipios")
    End Sub
    ...
    Private Sub GridView1_RowDeleting(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewDeleteEventArgs) Handles GridView1.RowDeleting
        CodigoRol = GridView1.Rows(e.RowIndex).Cells(2).Text
        CodigoEstado = GridView1.Rows(e.RowIndex).Cells(4).Text
        Ok = cFunciones.Ejecutar(sNombreBorrado, dtParametros(CodigoRol, CodigoEstado), sMensaje)
        Mensaje(sMensaje)
        If Ok Then
            llenarGrid()
        End If
    ...
    Private Sub GridView1_RowEditing(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewEditEventArgs) Handles GridView1.RowEditing
        Session("IdRol") = GridView1.Rows(e.NewEditIndex).Cells(2).Text
        Session("IdEstado") = GridView1.Rows(e.NewEditIndex).Cells(4).Text
...
#Region "Metodos"
    ...
    Private Function dtParametrosExportar() As DataTable
        Try
            ...
            dtParametrosExportar.Rows.Add("Departamento", cboRoles.Text)
    ...
    Private Function dtParametros() As DataTable
        ...
        End Try
    End Function
    Private Function dtParametros(ByVal idRol As String, ByVal idEstado As String) As DataTable
        Try
            dtParametros = cFunciones.dtDatos.Clone
