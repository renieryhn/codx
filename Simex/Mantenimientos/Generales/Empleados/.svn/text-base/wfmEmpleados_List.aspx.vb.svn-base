Imports prjDatos
Public Class wfmEmpleados_List
    Inherits System.Web.UI.Page
    Dim cFunciones As New funciones
    Private sMensaje As String = ""
    Private Codigo As String = ""
    Dim Ok As Boolean
    Private sNombreBusqueda As String = "pEmpleados_List"
    Private sNombreBorrado As String = "pEmpleados_Delete"
    Private pageTitle = "Empleados"
...
#Region "Eventos"
    ...
    Protected Sub btnExportar_Click(ByVal sender As Object, ByVal e As EventArgs)
        Master.Exportar(GridView1, dtParametrosExportar, "Mantenimiento de Empleados")
    End Sub
