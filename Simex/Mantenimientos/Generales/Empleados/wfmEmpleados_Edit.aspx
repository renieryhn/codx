<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="wfmEmpleados_Edit.aspx.vb" Inherits="smx.wfmEmpleados_Edit" MasterPageFile="~/Propiedades.Master" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphContenido" runat="server">
    <table class="DD" style="width: 369px">
            <tr>
                <td class="style2" align="left" style="margin-left: 160px; width: 227px;">
            ...
            <tr>
                <td class="style2" align="left" style="width: 227px">
                    <asp:Label ID="Label2" runat="server" Text="Num. Identidad"></asp:Label>
                </td>
                <td style="width: 240px">
            ...
            <tr>
                ...
                <td style="width: 240px">
                    <uc2:ComboBox ID="cboOficina" runat="server" AutoFill="True" 
                        FieldName="idDeptoOficina" idFieldName="id" TableName="Oficina" 
                        textFieldName="Nombre" />
                </td>
            </tr>
            <tr>
