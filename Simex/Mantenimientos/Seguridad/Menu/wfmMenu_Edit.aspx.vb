Imports prjDatos
Public Class wfmMenu_Edit
    Inherits System.Web.UI.Page
    Private Funciones As New funciones
    Private dtDatos As New DataTable
    Private sMensaje As String = ""
    Private Const spNombre As String = "pMenu_Edit"
    Private Const spListNombre As String = "pMenu_List"
    Private sNombreMantenimiento = "Editar Menu"
#Region "Eventos"
...
#Region "Metodos"
    Private Sub CargarValores()
        Try
            If Session("ID") <> "" Then
                ...
                cboMenuPadre.Value = dtDatos.Rows(0).Item(cboMenuPadre.FieldName).ToString
                txtPosicion.Text = dtDatos.Rows(0).Item(txtPosicion.FieldName).ToString
                cbHabilitado.Checked = dtDatos.Rows(0).Item("Habilitado").ToString
                txtUrl.Text = dtDatos.Rows(0).Item(txtUrl.FieldName).ToString
                cbMostrarMenu.Checked = dtDatos.Rows(0).Item("indMostrarMenu").ToString
            End If
    ...
    Public Function dtParametros(Optional ByVal bInactivo As Boolean = False) As DataTable
        Try
            ...
            dtParametros.Rows.Add(cboMenuPadre.FieldName, cboMenuPadre.Value)
            dtParametros.Rows.Add(txtPosicion.FieldName, txtPosicion.Text)
            dtParametros.Rows.Add("Habilitado", cbHabilitado.Checked)
            dtParametros.Rows.Add(txtUrl.FieldName, txtUrl.Text)
            dtParametros.Rows.Add("indMostrarMenu", cbMostrarMenu.Checked)
