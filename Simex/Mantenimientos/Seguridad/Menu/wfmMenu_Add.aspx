<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="wfmMenu_Add.aspx.vb" Inherits="smx.wfmMenuAdd" MasterPageFile="~/Propiedades.Master" %>
            ...
            <tr>
                ...
                <td>
                    <uc1:TextBox ID="txtUrl" runat="server" FieldName="Url" Int="False" 
                        Obligatorio="False" MaxLength="200" width="500" />
                </td>
            </tr>
            <tr>
                <td class="style2" align="left">
