Imports prjDatos
Public Class wfmMenuAdd
    Inherits System.Web.UI.Page
    Private Funciones As New funciones
    Private sMensaje As String = ""
    Private Const spNombre As String = "pMenu_Add"
    Private sNombreMantenimiento = "Agregar Menu"
#Region "Eventos"
...
#Region "Metodos"
    ...
    Public Function dtParametros(Optional ByVal bInactivo As Boolean = False) As DataTable
        Try
            ...
            dtParametros.Rows.Add(txtCodigo.FieldName, System.DBNull.Value)
