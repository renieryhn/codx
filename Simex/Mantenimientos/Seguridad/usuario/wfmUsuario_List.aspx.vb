Imports prjDatos
Public Class wfmUsuario_List
    Inherits System.Web.UI.Page
#Region "Declaraciones"
    Dim cFunciones As New funciones
    Private sNombreBusqueda As String = "pUsuario_List"
    Private sNombreBorrado As String = "pUsuario_Delete"
    Private sNombreMantenimiento = "Mantenimiento de Usuarios"
...
#Region "Eventos"
    ...
    Protected Sub btnExportar_Click(ByVal sender As Object, ByVal e As EventArgs)
        Master.Exportar(GridView1, dtParametrosExportar, "Mantenimiento de Usuarios")
    End Sub
...
#Region "Metodos"
    ...
    Private Function dtParametrosExportar() As DataTable
        Try
            ...
            dtParametrosExportar.Rows.Add("Usuario", iUsuario)
