<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="wfmRolMenu_Add.aspx.vb" Inherits="smx.wfmRolMenu_Add" MasterPageFile="~/Propiedades.Master" %>
            ...
            <tr>
                ...
                <td>
                    <uc2:ListBox ID="cbRol" runat="server" AutoFill="True" FieldName="idRol" 
                        idFieldName="id" Obligatorio="True" postBack="True" TableName="Rol" 
            ...
            <tr>
                ...
                <td>
                    <uc2:ListBox ID="cboMenu" runat="server" FieldName="MenuId" 
                        idFieldName="Menu.MenuId" TableName="Menu" textFieldName="Menu.Descripcion" 
                        AutoFill="True" idParentComboBox="idRol" 
                        Consulta="Select Menu.MenuId, Menu.Descripcion From Menu where 1=1 and menu.MenuId not in (select RolMenu.MenuId from rolmenu where Rolmenu.idRol=@Filtro)" 
                        Obligatorio="True" />
                </td>
            </tr>
            <tr>
