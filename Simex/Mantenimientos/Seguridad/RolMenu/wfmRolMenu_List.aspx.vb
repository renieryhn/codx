...
#Region "Declaraciones"
    ...
    Dim Ok As Boolean
    Private sNombreBusqueda As String = "pRolMenu_List"
    Private sNombreBorrado As String = "pRolMenu_Delete"
    Private sNombreMantenimiento = "Mantenimiento Menu Rol"
...
#Region "Eventos"
    ...
    Protected Sub btnExportar_Click(ByVal sender As Object, ByVal e As EventArgs)
        Master.Exportar(GridView1, dtParametrosExportar, "Mantenimiento de Asignacion de permisos a Roles")
    End Sub
...
#Region "Metodos"
    ...
    Private Function dtParametros() As DataTable
        Try
            ...
            dtParametros.Rows.Add(cbMenu.FieldName, cbMenu.Value)
        Catch ex As Exception
            Throw (ex)
        End Try
    End Function
    ...
    Private Function dtParametrosExportar() As DataTable
        Try
            ...
            dtParametrosExportar.Rows.Add("Menu", cbMenu.Text)
        Catch ex As Exception
            Throw (ex)
        End Try
    End Function
