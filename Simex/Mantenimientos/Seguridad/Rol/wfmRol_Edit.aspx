<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="wfmRol_Edit.aspx.vb" Inherits="smx.wfmRol_Edit" MasterPageFile="~/Propiedades.Master" %>
...
<table class="DD">
            ...
            <tr>
                ...
                <td>
                    <uc1:TextBox ID="txtDescripcion" runat="server" Height="50" MaxLength="150" 
