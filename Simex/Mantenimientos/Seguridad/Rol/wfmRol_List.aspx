<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="wfmRol_List.aspx.vb" Inherits="smx.wfmRol_List" MasterPageFile="~/Consulta.Master" %>
...
<asp:Content ID="Content1" runat="server" 
	...
	<table class="DD" style="width: 720px">
            <tr>
            ...
            <tr>
                ...
                <td class="style2" colspan="2">
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                        ...
                        EmptyDataText="No se encontraron registros" CssClass="mGrid" BorderStyle="None" BorderWidth="1px" CellSpacing="2" Width="616px" >
                    ...
                    <asp:HyperLink ID="linkModificar" runat="server" 
                        NavigateUrl="~/Mantenimientos/Seguridad/Rol/wfmRol_Edit.aspx" 
