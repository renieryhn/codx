Imports prjDatos
Public Class wfmRol_Edit
    Inherits System.Web.UI.Page
    Private Funciones As New funciones
    Private dtDatos As New DataTable
    Private sMensaje As String = ""
    Private Const spNombre As String = "pRol_Edit"
    Private Const spListNombre As String = "pRol_List"
    Private sNombreMantenimiento = "Editar Rol"
#Region "Eventos"
    ...
    Private Sub CargarValores()
        Try
            If Session("ID") <> "" Then
                ...
                txtDescripcion.Text = dtDatos.Rows(0).Item(txtDescripcion.FieldName)
            End If
