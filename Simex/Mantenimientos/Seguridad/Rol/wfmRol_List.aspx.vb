Imports prjDatos
Public Class wfmRol_List
    Inherits System.Web.UI.Page
    Dim cFunciones As New funciones
    Private sMensaje As String = ""
    Private Codigo As String = ""
    Dim Ok As Boolean
    Private sNombreBusqueda As String = "pRol_List"
    Private sNombreBorrado As String = "pRol_Delete"
    Private sNombreMantenimiento = "Mantenimiento de Roles"
#Region "Eventos"
    ...
    Protected Sub btnExportar_Click(ByVal sender As Object, ByVal e As EventArgs)
        Master.Exportar(GridView1, dtParametrosExportar, "Mantenimiento de Roles de Usuario")
    End Sub
