Imports prjDatos
Public Class wfmPuestosJuntaDirectiva_List
    Inherits System.Web.UI.Page
    Dim cFunciones As New funciones
    Private sMensaje As String = ""
    Private Codigo As String = ""
    Dim Ok As Boolean
    Private sNombreBusqueda As String = "pUR_PuestoJuntaDirectiva_List"
    Private sNombreBorrado As String = "pUR_PuestoJuntaDirectiva_Delete"
    Private pageTitle = "PuestosJuntaDirectiva"
...
#Region "Eventos"
    ...
    Protected Sub btnExportar_Click(ByVal sender As Object, ByVal e As EventArgs)
        ...
        llenarGrid()
        Master.Exportar(GridView1, dtParametrosExportar, "Mantenimiento de Puestos de Junta Directiva")
    End Sub
