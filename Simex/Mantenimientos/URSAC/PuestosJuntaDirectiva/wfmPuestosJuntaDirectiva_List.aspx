<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="wfmPuestosJuntaDirectiva_List.aspx.vb" Inherits="smx.wfmPuestosJuntaDirectiva_List" MasterPageFile="~/Consulta.Master" %>
...
<asp:Content ID="Content1" runat="server" 
   ...
   <p>
                    ...
                    <asp:HyperLink ID="linkModificar" runat="server" 
                        NavigateUrl="~/Mantenimientos/URSAC/PuestosJuntaDirectiva/wfmPuestosJuntaDirectiva_Edit.aspx" 
