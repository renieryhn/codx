<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="wfmPuestosJuntaDirectiva_Edit.aspx.vb" Inherits="smx.wfmPuestosJuntaDirectiva_Edit" MasterPageFile="~/Propiedades.Master" %>
...
<asp:Content ID="Content1" runat="server" contentplaceholderid="cphContenido">
      ...
      <asp:HyperLink ID="linkMain" runat="server" 
                        NavigateUrl="~/Mantenimientos/URSAC/PuestosJuntaDirectiva/wfmPuestosJuntaDirectiva_List.aspx" 
                        Visible="False">[linkMain]</asp:HyperLink>
         
                    <asp:HyperLink ID="linkMe" runat="server" 
                        NavigateUrl="~/Mantenimientos/URSAC/PuestosJuntaDirectiva/wfmPuestosJuntaDirectiva_Add.aspx" 
