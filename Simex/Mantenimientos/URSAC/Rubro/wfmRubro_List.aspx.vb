Imports prjDatos
Public Class wfmRubro_List
    Inherits System.Web.UI.Page
    Dim cFunciones As New funciones
    Private sMensaje As String = ""
    Private Codigo As String = ""
    Dim Ok As Boolean
    Private sNombreBusqueda As String = "pUR_Rubro_List"
    Private sNombreBorrado As String = "pUR_Rubro_Delete"
    Private pageTitle = "Rubro"
...
#Region "Eventos"
    ...
    Protected Sub btnExportar_Click(ByVal sender As Object, ByVal e As EventArgs)
        Master.Exportar(GridView1, dtParametrosExportar, "Mantenimiento de Rubro")
    End Sub
