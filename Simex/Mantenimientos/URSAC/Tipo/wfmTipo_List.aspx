<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="wfmTipo_List.aspx.vb" Inherits="smx.wfmTipo_List" MasterPageFile="~/Consulta.Master" %>
...
<asp:Content ID="Content1" runat="server" 
   ...
   <p>
                    ...
                    <asp:HyperLink ID="linkModificar" runat="server" 
                        NavigateUrl="~/Mantenimientos/URSAC/Tipo/wfmTipo_Edit.aspx" 
