<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="wfmTipo_Edit.aspx.vb" Inherits="smx.wfmTipo_Edit" MasterPageFile="~/Propiedades.Master" %>
...
<asp:Content ID="Content1" runat="server" contentplaceholderid="cphContenido">
      ...
      <asp:HyperLink ID="linkMain" runat="server" 
                        NavigateUrl="~/Mantenimientos/URSAC/Tipo/wfmTipo_List.aspx" 
                        Visible="False">[linkMain]</asp:HyperLink>
         
                    <asp:HyperLink ID="linkMe" runat="server" 
                        NavigateUrl="~/Mantenimientos/URSAC/Tipo/wfmTipo_Add.aspx" 
