<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="wfmSubtipo_List.aspx.vb" Inherits="smx.wfmSubtipo_List" MasterPageFile="~/Consulta.Master" %>
            ...
            <tr>
                ...
                <td align="left" class="style5" style="width: 868px">
                    <uc2:ComboBox ID="cboTipo" runat="server" AutoFill="True" 
                        FieldName="idTipo" idFieldName="id" Obligatorio="False" 
            ...
            <tr>
                ...
                <td class="style2" colspan="2">
                    ...
                    <asp:HyperLink ID="linkModificar" runat="server" 
                        NavigateUrl="~/Mantenimientos/URSAC/Subtipo/wfmSubtipo_Edit.aspx" 
