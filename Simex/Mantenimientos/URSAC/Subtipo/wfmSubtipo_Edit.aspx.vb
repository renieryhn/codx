Imports prjDatos
Public Class wfmSubtipo_Edit
    Inherits System.Web.UI.Page
    Private Funciones As New funciones
    Private dtDatos As New DataTable
    Private sMensaje As String = ""
    Private Const spNombre As String = "pUR_Subtipo_Edit"
    Private Const spListNombre As String = "pUR_Subtipo_List"
    Private sNombreMantenimiento = "Editar Subtipo"
#Region "Eventos"
    ...
    Private Sub CargarValores()
        Try
            If Session("ID") <> "" Then
                ...
                cboTipo.Value = dtDatos.Rows(0).Item(cboTipo.FieldName)
